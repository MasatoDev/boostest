export function boostestExportDefaultClassWithDecl<T>(isArray = false) {
	return new ref_12fae1d22129f5416a6cfadce6cb7c022b04c462cb3673c30d6e5f844bcaf74e("test string data", {
...
type main_output_target = ["classReference", ref_12fae1d22129f5416a6cfadce6cb7c022b04c462cb3673c30d6e5f844bcaf74e, [
  string,
...
type main = ref_12fae1d22129f5416a6cfadce6cb7c022b04c462cb3673c30d6e5f844bcaf74e;
class ref_12fae1d22129f5416a6cfadce6cb7c022b04c462cb3673c30d6e5f844bcaf74e {
    name: string;
    chips: ref_4100094c561191d37aa3a0fc460944fc7a7555efc6341ca1ec605cd421a2e491;
    constructor(name: string, chips: ref_b0f94f34364e7baaf1dddeb371bc288fb648e19e3ff324906e4ec48878a7867e) {
        this.name = name;
        this.chips = chips;
    }
}
interface ref_4100094c561191d37aa3a0fc460944fc7a7555efc6341ca1ec605cd421a2e491 {
    name: string;
    age: number;
    sex: 1 | 2;
    short_name: "john" | "doe";
...
interface ref_b0f94f34364e7baaf1dddeb371bc288fb648e19e3ff324906e4ec48878a7867e {
    name: string;
    age: number;
    sex: 1 | 2;
    short_name: "john" | "doe";
