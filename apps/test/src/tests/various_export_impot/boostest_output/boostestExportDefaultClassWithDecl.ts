export function boostestExportDefaultClassWithDecl<T>(isArray = false) {
	return new ref_c726debd6066a048e95b7b6bb7caebf7cd7b53dbd5a0e9cf7794b5b224e188ca("test string data", {
...
type main_output_target = ["classReference", ref_c726debd6066a048e95b7b6bb7caebf7cd7b53dbd5a0e9cf7794b5b224e188ca, [
  string,
...
type main = ref_c726debd6066a048e95b7b6bb7caebf7cd7b53dbd5a0e9cf7794b5b224e188ca;
class ref_c726debd6066a048e95b7b6bb7caebf7cd7b53dbd5a0e9cf7794b5b224e188ca {
    name: string;
    chips: ref_e4556f5b781472348d961b382b2682bb47ce047ad58de9cd54b46b92bc2eba6a;
    constructor(name: string, chips: ref_e4556f5b781472348d961b382b2682bb47ce047ad58de9cd54b46b92bc2eba6a) {
        this.name = name;
        this.chips = chips;
    }
}
interface ref_e4556f5b781472348d961b382b2682bb47ce047ad58de9cd54b46b92bc2eba6a {
    name: string;
    age: number;
    sex: 1 | 2;
    short_name: "john" | "doe";
