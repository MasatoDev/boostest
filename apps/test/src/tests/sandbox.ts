type main_output_target = z.infer<
  ZodObject<{ username: ZodString }, "strip", ZodType<any, any, any>, any, any>
>; // Extracted from typeAlias

type main =
  ref_067f65c1875109430d4873be8b8f34119445e243aa56352530154d43faf5d255;
type ref_067f65c1875109430d4873be8b8f34119445e243aa56352530154d43faf5d255 =
  z.infer<
    typeof ref_35430666edf5be0179740308e4a70b470cd2f0071876d8aff52e8437075e53dd
  >;
...
namespace z {
  ...
  declare function createZodEnum<
    U extends string,
    T extends Readonly<[U, ...Array<U>]>,
  >(values: T, params?: RawCreateParams): ZodEnum<Writeable<T>>;
  declare function createZodEnum<U extends string, T extends [U, ...Array<U>]>(
    values: T,
    params?: RawCreateParams,
  ): ZodEnum<T>;
...
declare const ref_77ed9983e74876ca42a64666fc82bdc6da9cdc62ad60379f7b9b72b5f885e781;
type ref_7b801e0160ec86cfad07010d314280ae1f7f4a0e73ae5e9b906f2a387b70d5a0<
  Input = unknown,
  Output = Input,
> = {
  readonly "~standard": ref_7b801e0160ec86cfad07010d314280ae1f7f4a0e73ae5e9b906f2a387b70d5a0.Props<
    Input,
    Output
  >;
};
declare const ref_59a6fa11478437da15cb62ff13c2f1a272377a71e6d143e79e379b5681c70c0b;
const ref_35430666edf5be0179740308e4a70b470cd2f0071876d8aff52e8437075e53dd =
