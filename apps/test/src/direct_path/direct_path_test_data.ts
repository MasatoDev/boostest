export function boostestLiteralAliasType<T>(args?: Partial<T>): T {
	return ({
		...
		'tsTuple':['test string data', 10, 'any', tsTuple_RefType_boostestLiteralAliasType<any>(), tsTuple_RefTypeInterface_boostestLiteralAliasType<any>()],
		'tsNamedTuple':['test string data', 10, tsNamedTuple_RefType_boostestLiteralAliasType<any>(), tsNamedTuple_RefTypeInterface_boostestLiteralAliasType<any>()],
		'intersectionType':{
...
export function boostestLiteralInterfaceType<T>(args?: Partial<T>): T {
	return ({
		...
		'tsArray':[],
		'symbolLiteral':Symbol(),
		'tsTuple':['test string data', 10, 'any', tsTuple_RefType_boostestLiteralInterfaceType<any>(), tsTuple_RefTypeInterface_boostestLiteralInterfaceType<any>()],
		'tsNamedTuple':['test string data', 10, tsNamedTuple_RefType_boostestLiteralInterfaceType<any>(), tsNamedTuple_RefTypeInterface_boostestLiteralInterfaceType<any>()],
		'intersectionType':{
...
export function boostestLiteralTypeClass<T extends abstract new (...args: any) => any>(LiteralTypeClass): T {
	...
	}, [], referenceLiteral_RefType_boostestLiteralTypeClass<any>(), {}, 'string', 20, 10000000000000n, true, null, {}, [], Symbol(), ['test string data', 10, 'any', tsTuple_RefType_boostestLiteralTypeClass<any>(), tsTuple_RefTypeInterface_boostestLiteralTypeClass<any>()], ['test string data', 10, tsNamedTuple_RefType_boostestLiteralTypeClass<any>(), tsNamedTuple_RefTypeInterface_boostestLiteralTypeClass<any>()], {
	...
	}, {}, [], {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, refTypeInterface_RefTypeInterface_boostestLiteralTypeClass<any>());
}
