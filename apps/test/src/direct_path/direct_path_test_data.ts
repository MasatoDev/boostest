...
export function boostestLiteralTypeClass<T extends abstract new (...args: any) => any>(LiteralTypeClass): T {
	...
	}, [], referenceLiteral_RefType_boostestLiteralTypeClass<any>(), 'test string data', 'string', 20, 10000000000000n, true, null, {}, [], Symbol(), ['test string data', 10, 'any', tsTuple_RefType_boostestLiteralTypeClass<any>(), tsTuple_RefTypeInterface_boostestLiteralTypeClass<any>(), 'test string data'], ['test string data', 10, tsNamedTuple_RefType_boostestLiteralTypeClass<any>(), tsNamedTuple_RefTypeInterface_boostestLiteralTypeClass<any>(), 10], {
